/*
 * Multiverse Mages — task 10.1 (mages-and-species): every capability-spec
...
/**
 * Task 10.1 asks someone to *confirm* every scenario across the five
 * mages-and-species capability specs has a corresponding passing test.
 *
...
const SPEC_DIR = 'openspec/changes/mages-and-species/specs';
const MANIFEST_PATH = 'openspec/changes/mages-and-species/scenario-coverage.md';
