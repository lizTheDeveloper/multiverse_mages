 ...
 *
 * `state` is not in §5's original list. It was added by `core-contracts`: the
 * shared world-state types have to live somewhere every `rules-*` package can
 * reach, `sim-core` must stay content-agnostic, and putting them in
 * `rules-magic` would force `rules-world` to import it and break rule 3. See
 * the note beside the §5 diagram.
 */
const ALLOWED: Readonly<Record<string, { value: readonly string[]; typeOnly: readonly string[] }>> =
  {
    ...
    'rules-magic': { value: ['sim-core', 'content', 'state'], typeOnly: [] },
    'rules-world': { value: ['sim-core', 'content', 'state'], typeOnly: [] },
    'rules-raid': {
      value: ['sim-core', 'content', 'state', 'rules-magic', 'rules-world'],
      typeOnly: [],
    },
    'agent-api': {
      value: ['sim-core', 'content', 'state', 'rules-magic', 'rules-world', 'rules-raid'],
      typeOnly: [],
    },
