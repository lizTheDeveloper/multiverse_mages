 ...
 * 2. §1's totals row is the sum of the package rows, and equals 133.
 ...
 * 5. The 133 matches `scripts/reachability-baseline.json` — the document and the
...
describe('the reachability triage document', () => {
  ...
  it('has a totals row equal to the sum of the package rows, and to 133', () => {
