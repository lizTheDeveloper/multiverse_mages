...
export const REQUIRED_RAID_CONSTANTS: readonly string[] = Object.freeze([
  ...
  'inbound-raid-chance-per-world-tick',
  'inbound-raid-cooldown-world-ticks',
  'looted-grimoires-per-raid',
  ...
  'verb-conceal-cost',
  'verb-conceal-magnitude',
  'verb-forbid-cost',
  'verb-levy-cost',
  'verb-mend-cost',
  'verb-mend-hit-points',
  'verb-permit-cost',
  'verb-ward-cost',
  'verb-ward-magnitude',
