...
export const ACTION = {
  ...
  openPortal: 14,
  declareAscension: 15,
  // Appended by `w109/alliances` after this table was extracted, and restored
  // here on the `w21/timing-and-envelopes` merge: the extraction predates the
  // action, so the branch's copy of this file was missing it.
  inviteScholar: 16,
} as const;
