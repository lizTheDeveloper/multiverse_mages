# magic-traditions Specification

## Purpose
The four hooks a tradition may change behaviour through -- acquire, store, cast, cost -- and
the guarantee that it changes behaviour through no other path.
