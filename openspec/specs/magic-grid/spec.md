# magic-grid Specification

## Purpose
The technique x form grid: which cells exist, which the release enables, how a cell's
availability is decided, and how prerequisites and dormancy follow from that decision.
