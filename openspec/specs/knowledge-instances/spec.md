# knowledge-instances Specification

## Purpose
Knowledge as instances held in minds, palaces and books -- acquired by research or teaching,
degraded by decay, lost when the last one goes, and rediscovered at a multiple of its price.
