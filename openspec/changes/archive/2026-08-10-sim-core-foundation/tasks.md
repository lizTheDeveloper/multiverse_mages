...
*Added after the task 9.5 coverage audit. Every simulation property turned out to be well tested;
every gap was in the machinery meant to catch a future regression — which is precisely the
